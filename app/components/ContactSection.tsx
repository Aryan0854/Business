      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <h3 className="text-3xl font-bold mb-8 gradient-text">Connect With Me</h3>
            <div className="space-y-6">
              {contactLinks.map((link, index) => (
                <motion.a
                  ...
                  className="group flex items-center space-x-4 p-4 rounded-xl glass-effect hover:bg-white/10 transition-all duration-300"
                ...
                >
                  ...
                  <ArrowTopRightOnSquareIcon className="w-5 h-5 text-gray-400 group-hover:text-white transition-colors ml-auto" />
                </motion.a>
              ))}
            </div>
            ...
            >
              <h4 className="text-xl font-semibold mb-4 text-white">Why Choose Me?</h4>
